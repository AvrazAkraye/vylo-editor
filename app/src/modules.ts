...
export type ModuleId =
  | 'dashboard' | 'routines' | 'skills' | 'files' | 'search' | 'outline' | 'changes' | 'chats' | 'todo' | 'prompts' | 'browser' | 'plugins' | 'usage' | 'whatsapp' | 'research' | 'video' | 'slides' | 'memory';
...
export const MODULES: readonly Module[] = [
  ...
  { id: 'slides', label: 'Slides', icon: 'slides', about: 'Presentations from a sentence or a Research document: slides you edit, present, and save as PowerPoint or PDF.' },

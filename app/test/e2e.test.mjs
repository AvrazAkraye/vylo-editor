...
// exactly what the JSON it was sent describes.
{
  ...
  for (const absent of ['apply_write', 'pty_open', 'pty_write', 'pty_close', 'mcp_call', 'export_write', 'export_write_docx', 'export_write_video', 'save_pdf', 'reveal_path', 'open_exported', 'delete_path', 'git_commit']) {

...
content*, with no exception. Version 0.47.3 added a mode where the app can
...
any of them behind a confirmation that names what goes. Until 0.47.3 the
...
**The builds are not yet signed.** As of 0.47.3 the macOS and Windows binaries
...
*Last checked against 0.47.3. Every statement above was read out of the code. If

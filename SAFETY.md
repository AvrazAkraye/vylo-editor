...
**The builds are not yet signed.** As of 0.92.0 the macOS and Windows binaries
...
*Last checked against 0.92.0. Every statement above was read out of the code. If

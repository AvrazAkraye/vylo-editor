...
Since 0.64.0 the completion list is seeded from your shell's own history file —
...
**The builds are not yet signed.** As of 0.64.0 the macOS and Windows binaries
...
*Last checked against 0.64.0. Every statement above was read out of the code. If

...
any of them behind a confirmation that names what goes. Until 0.42.0 the
...
**The builds are not yet signed.** As of 0.42.0 the macOS and Windows binaries
...
*Last checked against 0.42.0. Every statement above was read out of the code. If
